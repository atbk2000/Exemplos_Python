...
#Função que retorna os confrontos do returno tomando como base
#os confrontos do primeiro turno
def calcReturno(turno1):

    returno = []

    for i in range(len(turno1)):

        if i % 2 == 0:
            returno.append(turno1[i + 1])
        else:
            returno.append(turno1[i - 1])
